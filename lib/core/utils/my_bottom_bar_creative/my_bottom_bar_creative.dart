...
class MyBottomBarCreative extends StatefulWidget {
  ...
  @override
  _MyBottomBarCreativeState createState() => _MyBottomBarCreativeState();
}

class _MyBottomBarCreativeState extends State<MyBottomBarCreative> {
  @override
  Widget build(BuildContext context) {
    ...
    double sizeHighlight =
        widget.highlightStyle?.sizeLarge == true ? 56.w : 40.w;
