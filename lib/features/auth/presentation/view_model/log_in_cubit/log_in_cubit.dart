...
class LogInCubit extends Cubit<LogInState> {
  ...
  Future<void> login() async {
    ...
    print("my:${phoneNumber!.completeNumber.trim()}");

    Either<ServerFailure, LoginModel> result = await _logInServices.logIn(
      phoneNumber: phoneNumber!.completeNumber.trim(),
    );
    ...
    result.fold(
      ...
      (data) async {
        ...
        emit(SendCodeSuccess(message: data.exists.toString()));
      },
    );
  }
  ...
  Future<void> register() async {
    ...
    result.fold(
      ...
      //success
      (postion) async {
        Either<ServerFailure, VerfiyModel> result =
        ...
        result.fold(
          ...
          (data) async {
            fakeCode = data.fcm;
            emit(SendCodeSuccess(message: data.verified.toString()));
          },
        );
      },
    );
